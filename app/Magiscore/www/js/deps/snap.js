  ...
  var Snap =
    ...
    function(userOpts) {
      ...
      this.toggle = function(side) {
        logConsole("[INFO]    " + viewController.settingsOpen);
        if (viewController.settingsOpen) viewController.closeSettings();
        else if (utils.klass.has(doc.body, "snapjs-left")) this.close();
        else this.open(side);
      };
