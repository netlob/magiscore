  ...
  setLatestGrades(grades) {
    ...
    grades.forEach(grade => {
      ...
      $("#latest-grades").append(`
          <a class="dropdown-item d-flex align-items-center vibrate" onclick="if(viewController.currentCourse == courseController.current()) { viewController.render('${grade.vak.omschrijving.capitalize()}') } else { viewController.renderCourse(viewController.currentCourse.course.id, true, false, '${grade.vak.omschrijving.capitalize()}') }">
